...
namespace Elements.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateLargeObjectRequest")]
    public partial class CreateLargeObjectRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLargeObjectRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLargeObjectRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLargeObjectRequest" /> class.
        /// </summary>
        ...
        public CreateLargeObjectRequest(string mimeType = default(string), SubjectRequest read = default(SubjectRequest), SubjectRequest write = default(SubjectRequest), SubjectRequest delete = default(SubjectRequest))
        {
            // to ensure "mimeType" is required (not null)
            if (mimeType == null)
            {
                throw new ArgumentNullException("mimeType is a required property for CreateLargeObjectRequest and cannot be null");
            }
            this.MimeType = mimeType;
            // to ensure "read" is required (not null)
            if (read == null)
            {
                throw new ArgumentNullException("read is a required property for CreateLargeObjectRequest and cannot be null");
            }
            this.Read = read;
            // to ensure "write" is required (not null)
            if (write == null)
            {
                throw new ArgumentNullException("write is a required property for CreateLargeObjectRequest and cannot be null");
            }
            this.Write = write;
            // to ensure "delete" is required (not null)
            if (delete == null)
            {
                throw new ArgumentNullException("delete is a required property for CreateLargeObjectRequest and cannot be null");
            }
            this.Delete = delete;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateLargeObjectRequest {\n");
