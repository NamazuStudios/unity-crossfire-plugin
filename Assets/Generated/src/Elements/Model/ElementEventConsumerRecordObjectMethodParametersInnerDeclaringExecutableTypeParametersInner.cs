...
{
    /// <summary>
    /// ElementEventConsumerRecordObjectMethodParametersInnerDeclaringExecutableTypeParametersInner
    /// </summary>
    [DataContract(Name = "ElementEventConsumerRecordObject_method_parameters_inner_declaringExecutable_typeParameters_inner")]
    public partial class ElementEventConsumerRecordObjectMethodParametersInnerDeclaringExecutableTypeParametersInner
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementEventConsumerRecordObjectMethodParametersInnerDeclaringExecutableTypeParametersInner" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="bounds">bounds.</param>
        /// <param name="genericDeclaration">genericDeclaration.</param>
        /// <param name="annotatedBounds">annotatedBounds.</param>
        /// <param name="typeName">typeName.</param>
        /// <param name="annotations">annotations.</param>
        /// <param name="declaredAnnotations">declaredAnnotations.</param>
        public ElementEventConsumerRecordObjectMethodParametersInnerDeclaringExecutableTypeParametersInner(string name = default(string), List<ElementEventConsumerRecordObjectMethodTypeParametersInnerBoundsInner> bounds = default(List<ElementEventConsumerRecordObjectMethodTypeParametersInnerBoundsInner>), Object genericDeclaration = default(Object), List<ElementEventConsumerRecordObjectMethodTypeParametersInnerAnnotatedBoundsInner> annotatedBounds = default(List<ElementEventConsumerRecordObjectMethodTypeParametersInnerAnnotatedBoundsInner>), string typeName = default(string), List<Object> annotations = default(List<Object>), List<Object> declaredAnnotations = default(List<Object>))
        {
            this.Name = name;
            this.Bounds = bounds;
        ...
        /// <summary>
        /// Gets or Sets GenericDeclaration
        /// </summary>
        [DataMember(Name = "genericDeclaration", EmitDefaultValue = false)]
        public Object GenericDeclaration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElementEventConsumerRecordObjectMethodParametersInnerDeclaringExecutableTypeParametersInner {\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  Bounds: ").Append(Bounds).Append("\n");
            sb.Append("  GenericDeclaration: ").Append(GenericDeclaration).Append("\n");
