...
namespace Elements.Model
{
    ...
    /// PaginationItem
    /// </summary>
    [DataContract(Name = "PaginationItem")]
    public partial class PaginationItem
    {
        ...
        public PaginationItem(int offset = default(int), int total = default(int), bool approximation = default(bool), List<Item> objects = default(List<Item>))
        {
            this.Offset = offset;
            this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginationItem {\n");
