...
namespace Elements.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GooglePlayApplicationConfiguration")]
    public partial class GooglePlayApplicationConfiguration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GooglePlayApplicationConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GooglePlayApplicationConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GooglePlayApplicationConfiguration" /> class.
        /// </summary>
        ...
        /// <param name="jsonKey">jsonKey.</param>
        /// <param name="productBundles">The list of product bundles that may be rewarded upon successful IAP transactions..</param>
        public GooglePlayApplicationConfiguration(string id = default(string), string name = default(string), string type = default(string), string description = default(string), Application parent = default(Application), string applicationId = default(string), Dictionary<string, Object> jsonKey = default(Dictionary<string, Object>), List<ProductBundle> productBundles = default(List<ProductBundle>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GooglePlayApplicationConfiguration and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GooglePlayApplicationConfiguration and cannot be null");
            }
            this.Name = name;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for GooglePlayApplicationConfiguration and cannot be null");
            }
            this.Type = type;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for GooglePlayApplicationConfiguration and cannot be null");
            }
            this.Description = description;
            // to ensure "parent" is required (not null)
            if (parent == null)
            {
                throw new ArgumentNullException("parent is a required property for GooglePlayApplicationConfiguration and cannot be null");
            }
            this.Parent = parent;
        ...
        /// <summary>
        /// Gets or Sets JsonKey
        /// </summary>
        [DataMember(Name = "jsonKey", EmitDefaultValue = false)]
        public Dictionary<string, Object> JsonKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GooglePlayApplicationConfiguration {\n");
