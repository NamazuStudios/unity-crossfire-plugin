...
namespace Elements.Model
{
    ...
    public partial class CreateApplicationRequest
    {
        ...
        public CreateApplicationRequest(string name = default(string), string description = default(string), Dictionary<string, Object> attributes = default(Dictionary<string, Object>))
        {
