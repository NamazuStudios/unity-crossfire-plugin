...
namespace Elements.Model
{
    ...
    public partial class FormDataBodyPart
    {
        ...
        public FormDataBodyPart(ContentDisposition contentDisposition = default(ContentDisposition), Object entity = default(Object), BodyPartHeaders headers = default(BodyPartHeaders), MediaType mediaType = default(MediaType), Object messageBodyWorkers = default(Object), MultiPart parent = default(MultiPart), Object providers = default(Object), string name = default(string), string value = default(string), Object content = default(Object), string fileName = default(string), bool simple = default(bool), FormDataContentDisposition formDataContentDisposition = default(FormDataContentDisposition), BodyPartParameterizedHeaders parameterizedHeaders = default(BodyPartParameterizedHeaders))
        {
