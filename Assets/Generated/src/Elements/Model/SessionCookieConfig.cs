...
namespace Elements.Model
{
    ...
    public partial class SessionCookieConfig
    {
        ...
        public SessionCookieConfig(string name = default(string), string path = default(string), Dictionary<string, string> attributes = default(Dictionary<string, string>), string comment = default(string), bool httpOnly = default(bool), bool secure = default(bool), int maxAge = default(int), string domain = default(string))
        {
            this.Name = name;
            this.Path = path;
