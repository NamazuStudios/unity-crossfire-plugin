...
namespace Elements.Model
{
    ...
    public partial class MultiPart
    {
        ...
        /// <param name="bodyParts">bodyParts.</param>
        /// <param name="parameterizedHeaders">parameterizedHeaders.</param>
        public MultiPart(ContentDisposition contentDisposition = default(ContentDisposition), Object entity = default(Object), BodyPartHeaders headers = default(BodyPartHeaders), MediaType mediaType = default(MediaType), Object messageBodyWorkers = default(Object), MultiPart parent = default(MultiPart), Object providers = default(Object), List<BodyPart> bodyParts = default(List<BodyPart>), BodyPartParameterizedHeaders parameterizedHeaders = default(BodyPartParameterizedHeaders))
        {
