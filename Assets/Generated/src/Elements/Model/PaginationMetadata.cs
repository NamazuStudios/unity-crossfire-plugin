...
namespace Elements.Model
{
    ...
    public partial class PaginationMetadata
    {
        ...
        public PaginationMetadata(int offset = default(int), int total = default(int), bool approximation = default(bool), List<Metadata> objects = default(List<Metadata>))
        {
            this.Offset = offset;
            this.Total = total;
        ...
        public List<Metadata> Objects { get; set; }
