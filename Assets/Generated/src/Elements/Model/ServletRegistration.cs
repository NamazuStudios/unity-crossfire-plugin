...
namespace Elements.Model
{
    ...
    public partial class ServletRegistration
    {
        ...
        public ServletRegistration(string runAsRole = default(string), List<string> mappings = default(List<string>), string name = default(string), string className = default(string), Dictionary<string, string> initParameters = default(Dictionary<string, string>))
        {
